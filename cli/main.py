...
app = typer.Typer(
    name="TradingCrew",
    help="TradingCrew CLI: Multi-Agents LLM Financial Trading Framework",
...
def update_display(layout, spinner_text=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to TradingCrew CLI[/bold green]\n"
            "[dim]© [Tauric Research](https://github.com/TauricResearch)[/dim]",
            title="Welcome to TradingCrew",
            border_style="green",
            padding=(1, 2),
            expand=True,
        )
...
def get_user_selections():
    ...
    welcome_content += "[bold green]TradingCrew: Multi-Agents LLM Financial Trading Framework - CLI[/bold green]\n\n"
