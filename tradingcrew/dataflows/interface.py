...
VENDOR_METHODS = {
    ...
    "get_indicators": {
        ...
        "akshare": get_akshare_indicators,  # A股
    },
    # fundamental_data
    "get_fundamentals": {
        "alpha_vantage": get_alpha_vantage_fundamentals,
        "openai": get_fundamentals_openai,
        "akshare": get_akshare_fundamentals,  # A股
    },
    "get_balance_sheet": {
        "alpha_vantage": get_alpha_vantage_balance_sheet,
        "yfinance": get_yfinance_balance_sheet,
        "local": get_simfin_balance_sheet,
        "akshare": get_akshare_balance_sheet,  # A股
    },
    "get_cashflow": {
        "alpha_vantage": get_alpha_vantage_cashflow,
        "yfinance": get_yfinance_cashflow,
        "local": get_simfin_cashflow,
        "akshare": get_akshare_cashflow,  # A股
    },
    "get_income_statement": {
        "alpha_vantage": get_alpha_vantage_income_statement,
        "yfinance": get_yfinance_income_statement,
        "local": get_simfin_income_statements,
        "akshare": get_akshare_income_statement,  # A股
    },
    # news_data
    "get_news": {
        ...
        "akshare": get_akshare_news,  # A股
    },
    "get_global_news": {
        "openai": get_global_news_openai,
        "local": get_reddit_global_news,
        "akshare": get_akshare_global_news,  # A股
    },
    "get_insider_sentiment": {
        "local": get_finnhub_company_insider_sentiment,
        "akshare": get_akshare_insider_sentiment,  # A股
    },
    "get_insider_transactions": {
        "alpha_vantage": get_alpha_vantage_insider_transactions,
        "yfinance": get_yfinance_insider_transactions,
        "local": get_finnhub_company_insider_transactions,
        "akshare": get_akshare_insider_transactions,  # A股
    },
}
